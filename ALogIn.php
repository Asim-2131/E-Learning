...
<body style="background-color: #f0f0e8; ">
  ...
  if (isset($_POST['login'])) 
  {
    ...
    {
      $password = $password;
      $query = "SELECT * FROM admindata WHERE EmailId='$email' AND PassWord='$password'";
...
<main id="main" > 
  <div class="container">
      ...
      <div class="d-flex justify-content-center align-items-center w-100">
          ...
          <h2 class="text-gradient-primary" style="color: black;"><b>Admin's Login Form</b></h2>
          </span>
        </div>
        <div class="card col-sm-7">
          <div class="card-body">
          <form id="login-form" method="post" action="ALogIn.php">
            ...
            <hr>
            <center><a href="ASignUp.php" class="btn btn-block btn-wave btn-success bg-gradient-success">Create New Account</a></center>

...
*/
  ...
  //if (isset($_SESSION['RollNo'])){ 
      ...
      $sql = "select * from studentdata where StudentId='$StudentId'";
    ...
    <div class="modal-content">
      <div class="box box-widget widget-user">
        ...
        <div class="widget-user-image">
          <img style="width: 25%" class="img-circle" src="<?php echo $spic;?>" alt="User Avatar"  width="50px" height="50px">
        </div>
      </div>
      <br><br><br>
      ...
      <div class="modal-footer">
        <a href = "AdminStudentData.php"><button type="button" class="btn btn-primary" >Close</button></a>
  ...
  if(isset($_POST['SaveChanges'])){
    ...
    if($_POST['pass'] != $_POST['cpass']){
      ...
      if(mysqli_query($connect,$sql)){
        echo "
      <script>
      window.location = 'AdminStudentData.php';
      </script>";
      }
      else{

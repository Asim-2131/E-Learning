<?php 
  ...
  if (isset($_SESSION['EmailId'])){ 
      ...
      $sql = "select * from teacherdata where EmailId='$EmailId'";
...
@keyframes changetext
{
  0%{content: "Learning,";}
  50%{content: "Learners,";}
  100%{content: "bringing the first two loves together.";}
}
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <div class="modal-body">
          <form action = "TeacherList.php" method = "POST" enctype="multipart/form-data" style = "padding-left:30px">
        ...
        <main>
            <section>
                ...
                <h1>Teachers have 3 loves: love of
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="../ProjectELearning/ReportTeacher/ReportT.php" id="report">Report<i class="fa fa-info-circle pull-right"></i></a>  
...
<footer>
        <p class="p-3 text-center foot">@18BCE{256,261},19BCE530<br>
            <a href="https://facebook.com/"><img src="OutDatabase/facebook.png" width="20" height="20"></a>
            &nbsp;&nbsp;

<?php 
  ...
  if (isset($_SESSION['EmailId'])){ 
      ...
      $sql = "select * from admindata where EmailId='$EmailId'";
...
<body>
  <?php  if (isset($_SESSION['EmailId'])) : 
    ...
    $sql = "select * from admindata where EmailId='$email'";
    $result = mysqli_query($connect,$sql);
    if(mysqli_num_rows($result)){
      while($row = mysqli_fetch_assoc($result)){
      $name = $row['Name'];
  ...
  <nav class="navbar navbar-expand-lg hi">
        <a class="navbar-brand" href="AdminMainPage.php">
    ...
    <div class="modal-content">
      <div class="box box-widget widget-user">
        ...
        <div class="widget-user-image">
          <img style="width: 25%" class="image-fluid image-thumbnail rounded-circle" src="<?php echo $tpic;?>" alt="User Avatar" width="50px" height="50px">
        </div>
      </div>
      <br><br><br>
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <div class="modal-body">
          <form action = "AdminList.php" method = "POST" enctype="multipart/form-data" style = "padding-left:30px">
        ...
        <main>
            <section>
                ...
                <h1>Welcome to Administrative Panel,
  ...
  <div id="mySidenav" class="sidenav">
    ...
    <a href="AdminStudentData.php" id="exercise" target = "frame2">Students <i class="fas fa-pen pull-right"></i></a>
...
<?php
  ...
  if(isset($_POST['SaveChanges'])){
    ...
    if($_POST['pass'] != $_POST['cpass']){
      ...
      $sql = "update admindata set Name = '$nn',MobileNo ='$Mobb',Address = '$addd',PassWord = '$passs',tpic = '$StoredPath' where AdminId = $adminid";

...
<body style="background-color: #f0f0e8; ">
	<?php
  $nameErr = $mobileErr = $emailErr = $addressErr = $password1Err = $password2Err = "";
  $name = $mobile = $email = $address = $sub2 = $password1 = $password2 = "";
  $errors = array(); 
  ...
  if (isset($_POST['signup'])) 
  {
    ...
    $user_check_query = "SELECT * FROM admindata WHERE EmailId='$email' LIMIT 1";
    ...
    {
    	$password = $password1;
    	$query = "INSERT INTO admindata VALUES('','$name','$mobile','$address','$email','$password','$path')";
...
<div class="container-fluid">
    <div class="d-flex justify-content-center align-items-center w-100">
          ...
          <h2 class="text-gradient-primary" style="color: black;"><b>Admin's SignUp Form</b></h2><h6 style="color: black;">All fields are mendetory</h6>
          </span>
        </div>
    <form method="post" action="ASignUp.php"  enctype="multipart/form-data" >
        <div class="col-lg-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
<div class="form-group col-md-12">
        <input type="text" class="form-control" id="inputName4" value="<?php echo $name;?>" name="name" placeholder="Admin's Name">
        <span class="error"><?php echo $nameErr;?></span>
    </div>
</div>
                    <div class="row">
<div class="form-group col-md-12">
        <input type="email" class="form-control" id="inputEmail4" value="<?php echo $email;?>" name="email" placeholder="Admin's Email ID">
...
<div class="form-group d-flex justify-content-center rounded-circle">
        ...
        <hr>
        <center><a href="ALogIn.php" class="btn btn-block btn-wave btn-success col-sm-5 bg-gradient-success">Log-In</a></center>
        <hr><hr>
        <h6 style="color: black;">For Students:</h6>
      <center><a href="SSignUp.php" class="btn btn-block btn-wave btn-secondary col-sm-5 bg-gradient-secondary">Sign-Up</a></center>

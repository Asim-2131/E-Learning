...
<div class="container">
	<h1 style = "padding-left : 30px"> Add File</h1>
	<hr>
	<br>
	<br>
...
<div class="col-md-4 offset-md-4">
		<form action = "InsertData.php" method = "POST" enctype="multipart/form-data" style = "padding-left:30px">
			<div class = "form-group">
				...
				<input class="form-control"placeholder="Enter Chepter" name = 'chapter' required>
			</div>
			<div class = "form-group">
			...
			<div class="center">
        <button type = "submit" class = "btn btn-success" name = "addFile">Add</button>
			</div>
		</form>
		</div>
	</div>

...
<body style="background-color: #f0f0e8; ">
  ...
  if (isset($_POST['signup'])) 
  {
    ...
    {
    	$password = $password1;
    	$query = "INSERT INTO teacherdata VALUES('','$name','$mobile','$address','$email','$password','$path')";
...
<div class="container-fluid">
    <div class="d-flex justify-content-center align-items-center w-100">
          ...
          <h2 class="text-gradient-primary" style="color: black;"><b>Teacher's SignUp Form</b></h2><h6 style="color: black;">All fields are mendetory</h6>
          </span>
        </div>
    <form method="post" action="TSignUp.php"  enctype="multipart/form-data" >
        <div class="col-lg-12">
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
<div class="form-group col-md-12">
        <input type="text" class="form-control" id="inputName4" value="<?php echo $name;?>" name="name" placeholder="Teacher's Name">
...
<div class="form-group d-flex justify-content-center rounded-circle">
        ...
        <hr>
        <center><a href="TLogIn.php" class="btn btn-block btn-wave btn-success col-sm-5 bg-gradient-success">Log-In</a></center>
        <hr><hr>
